...
from .schemas import PredictionStatus, TriageRequest, TriageResponse, UrgencyLevel


DEFAULT_MODEL_PATH = Path(__file__).resolve().parent / "models" / "followup_triage.joblib"
...
class TriageModel:
    ...
    def _load_bundle(self) -> ModelBundle | None:
        model_path = Path(os.getenv("AI_TRIAGE_MODEL_PATH", str(DEFAULT_MODEL_PATH)))
