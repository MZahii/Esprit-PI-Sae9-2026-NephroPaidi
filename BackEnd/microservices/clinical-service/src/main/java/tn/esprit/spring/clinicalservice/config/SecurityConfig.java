...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http, HandlerMappingIntrospector introspector) throws Exception {
        ...
        http.authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(mvcMatcherBuilder.pattern(HttpMethod.GET, "/clinical/consultations/backoffice/list"))
                    .hasAnyRole("ADMIN", "PLATFORM_ADMIN", "DOCTOR", "LAB_AGENT")
                .requestMatchers(mvcMatcherBuilder.pattern(HttpMethod.GET, "/clinical/consultations/{id}/lab-requests"))
                    .hasAnyRole("DOCTOR", "SURGEON", "LAB_AGENT")
                .requestMatchers(mvcMatcherBuilder.pattern(HttpMethod.POST, "/clinical/consultations/{id}/lab-requests"))
                    .hasAnyRole("DOCTOR", "SURGEON", "LAB_AGENT")
